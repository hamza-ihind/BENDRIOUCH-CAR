...
export const TracingBeam = ({
  ...
  const y2 = useSpring(
    useTransform(scrollYProgress, [0, 0.9], [50, svgHeight - 200]),
    {
      stiffness: 500,
      damping: 90,
    }
  ...
  return (
    <motion.div ref={ref} className={cn("relative", className)}>
      <div className="absolute left-[-200px] max-xl:hidden h-[100%]">
        <motion.div
          transition={{
            duration: 0.2,
            delay: 0.5,
        ...
        >
          ...
          <defs>
            ...
            >
              <stop stopColor="#FFB347" stopOpacity="0"></stop>
              <stop stopColor="#FFB347"></stop>
              <stop offset="0.325" stopColor="#FF7F50"></stop>
